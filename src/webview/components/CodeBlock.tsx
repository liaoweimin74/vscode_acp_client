	...
	return (
		<div className="acp-code-block">
				...
				>
					{copied ? (
						<svg width="14" height="14" viewBox="0 0 16 16" fill="none">
							<path d="M3 8L6.5 11.5L13 4.5" stroke="var(--acp-success)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
						</svg>
					) : (
						<svg width="14" height="14" viewBox="0 0 16 16" fill="none">
			...
			<pre className="acp-code-block__pre">
				<code className={`acp-code-block__code hljs language-${language ?? "text"}`} dangerouslySetInnerHTML={{ __html: highlighted }} />
			</pre>
		</div>
	);
}
